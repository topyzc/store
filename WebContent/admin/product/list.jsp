...
<HTML>
	<HEAD>
		...
		<script type="text/javascript">
			...
			function dele(pid){
				if(confirm("确定删除?")){
					location.href="${ pageContext.request.contextPath }/adminProduct?method=del&id="+pid;
				}
			}
								...
								<c:forEach items="${list }" var="p" varStatus="vs">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td align="center" style="HEIGHT: 22px">
													...
													<a href="javascript:void(0);" onclick="dele('${p.pid}')" class="delete"><button type="button" class="btn btn-danger btn-sm"> <span class="glyphicon glyphicon-trash" aria-hidden="true"></span>删除</button></a>
